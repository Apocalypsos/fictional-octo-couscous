...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/Apocalypsos/friendly-computing-machine/master/langIndex.json", function (json) {
    ...
    var translatorLV = "Apocalypso @mta.dga.lv"
    ...
    var basicBot = {
        ...
        name: "LatvianBot",
        loggedInID: null,
        scriptLink: "https://rawgit.com/Apocalypsos/fictional-octo-couscous/master/latvianbot.js",
        cmdLink: "http://git.io/245Ppg",
        chatLink: "https://rawgit.com/Apocalypsos/fictional-octo-couscous/master/lv.json",
        chat: null,
        loadChat: loadChat,
            ...
            sourceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat('/me Šo mākslīgo intelektu radīja ' + botCreator + ', uztur pašlaik ' + botMaintainer + ' un latviski tulkojis ' + translatorLV +".");
                    }
                }
            },
